<template>
  <q-layout view="hHh lpR fFf">
    <q-header elevated class="bg-lime text-white" height-hint="98">
      <q-toolbar>
        <q-btn dense flat round icon="menu" @click="toggleLeftDrawer" />

        <q-toolbar-title>
          <q-avatar>
            <img src="https://cdn.quasar.dev/logo-v2/svg/logo-mono-white.svg" alt="Electronic Store Logo">
          </q-avatar>
    ...
    >
      <q-carousel-slide :name="1" class="carousel-slide" img-src="https://i.pinimg.com/564x/7c/6b/87/7c6b8746fdfecd2dee3377677e886f72.jpg" />
      <q-carousel-slide :name="2" class="carousel-slide" img-src="https://i.pinimg.com/236x/49/e0/70/49e07022188c6613aa6db9f732c8d05a.jpg" />
      <q-carousel-slide :name="3" class="carousel-slide" img-src="https://i.pinimg.com/564x/a6/30/4b/a6304b9120ad514fa731255017351b8d.jpg" />
      <q-carousel-slide :name="4" class="carousel-slide" img-src="https://i.pinimg.com/564x/3d/07/8c/3d078c0f40aec900fb2e8d176001f899.jpg" />
    </q-carousel>
  </div>
    </q-page-container>
